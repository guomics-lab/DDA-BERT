...
##Figure3A: PSMs barplot (0.4 ~ 40 cells)
figure3 <- read_excel('E:\\github\\DDA-BERT\\DDA-BERT_figure_2024.xlsx', sheet = "single-cell")
colnames(figure3)[2] <- "Sample_type"

df <- pivot_longer(figure3, cols = starts_with(c("DDA-BERT", "FragPipe", "Sage")), 
                   names_to = c("Tool"), 
                   names_pattern = "(.*)", 
                   values_to = "PSMs")
...
ggplot(data_summary_stats, aes(x = Sample_type, y = mean_Proteins, fill = Tool)) +
  geom_bar(stat = "identity", position = "dodge", width = 0.7) +
  geom_errorbar(aes(ymin = mean_Proteins - sd_Proteins, ymax = mean_Proteins + sd_Proteins), 
                position = position_dodge(0.7), width = 0.2) +
  labs(y = "# Proteins", x = "") +
  theme_minimal() +
  scale_fill_manual(values = c("Sage" = "#d97816", "FragPipe" = "#1193cc", "DDA-BERT" = "#893b8f")) +
  theme(
...
ggsave(filename = "E:\\github\\DDA-BERT\\psm_barplot\\Figure3_single-cell_PSMs_barplot.pdf", 
       plot = last_plot(),
       device = "pdf",
       width = 2.3,
       height = 2.3, 
...
##Figure3B: precursor barplot (0.4 ~ 40 cells)
figure2B <- read_excel('E:\\github\\DDA-BERT\\DDA-BERT_figure_2024.xlsx', sheet = "precursor_num")
colnames(figure2B)[5] <- "Sample_type"
single_cell_data <- figure2B %>% filter(PXD == "PXD047627")
colnames(single_cell_data)[8] <- "DDA_BERT"

df <- pivot_longer(single_cell_data, cols = starts_with(c("DDA_BERT", "FragPipe", "Sage")), 
                   names_to = c("Tool"), 
                   names_pattern = "(.*)", 
                   values_to = "Proteins")
...
data_summary_stats$Tool <- factor(data_summary_stats$Tool, levels = c("Sage", "FragPipe", "DDA_BERT"))
...
ggplot(data_summary_stats, aes(x = Sample_type, y = mean_Proteins, fill = Tool)) +
  ...
  labs(y = "# precursors", x = "") +
  theme_minimal() +
  scale_fill_manual(values = c("DDA_BERT" = "#893b8f", "FragPipe" = "#1193cc", "Sage" = "#d97816")) +
  theme(
    legend.position = "none",
    panel.grid = element_blank(), 
    axis.line = element_line(color = "black"),
...
ggsave(filename = "E:\\github\\DDA-BERT\\precursor_barplot\\Figure3_single-cell_precursor_barplot.pdf", 
       plot = last_plot(),
       device = "pdf",
       width = 2.3,
       height = 2.3, 
...
##Figure3C: peptide barplot (0.4 ~ 40 cells)
figure2B <- read_excel('E:\\github\\DDA-BERT\\DDA-BERT_figure_2024.xlsx', sheet = "peptide_num")
colnames(figure2B)[5] <- "Sample_type"
single_cell_data <- figure2B %>% filter(PXD == "PXD047627")
colnames(single_cell_data)[8] <- "DDA_BERT"
...
ggsave(filename = "E:\\github\\DDA-BERT\\peptide_barplot\\Figure3_single-cell_peptide_barplot.pdf", 
       plot = last_plot(),
       device = "pdf",
       width = 2.3,
       height = 2.3, 
...
##Figure3D: protein group barplot (0.4 ~ 40 cells)
figure2B <- read_excel('E:\\github\\DDA-BERT\\DDA-BERT_figure_2024.xlsx', sheet = "pro_num")
colnames(figure2B)[5] <- "Sample_type"
single_cell_data <- figure2B %>% filter(PXD == "PXD047627")
colnames(single_cell_data)[8] <- "DDA_BERT"
...
ggsave(filename = "E:\\github\\DDA-BERT\\pro_barplot\\Figure3_single-cell_pro_barplot.pdf", 
       plot = last_plot(),
       device = "pdf",
       width = 2.3,
       height = 2.3, 
...
##Figure3E: protein group venn (0.4 ~ 40 cells)
library(eulerr)
...
data_dda_bert <- read_and_merge_with_info("E:\\DDA-BERT\\peptide_per_protein\\dda_bert", "HeLa_digest_SPME_0_1ng")
data_sage <- read_and_merge_with_info("E:\\DDA-BERT\\peptide_per_protein\\sage", "HeLa_digest_SPME_0_1ng")
data_fp <- read_and_merge_with_info("E:\\DDA-BERT\\peptide_per_protein\\fp", "HeLa_digest_SPME_0_1ng")
...
ggsave("E:\\github\\DDA-BERT\\pro_venn\\Figure3_HeLa_digest_SPME_0_1ng_pro_venn.pdf", plot = p, device = "pdf", width = 1.7, height = 1.7)



##Figure3F: peptide_class_per_protein (0.1 ng peptide; 0.4 cells)
rm(list=ls())
...
ggplot(class_source_stats, aes(x = class, y = mean_count, fill = source)) +
  ...
  geom_errorbar(aes(ymin = mean_count, ymax = mean_count), 
                position = position_dodge(0.7), width = 0.2) +
...
ggsave(filename = "E:\\github\\DDA-BERT\\peptide_class_per_protein\\Figure3_0.1ng_peptide_class_per_protein.pdf", 
       plot = last_plot(),
       device = "pdf",
       width = 2.3,
       height = 2.3, 
...
##Figure3G: PSMs score distributions (0.4 ~ 40 cells)
rm(list=ls())
data <- read.csv("E:\\DDA-BERT\\score_distribution\\HeLa_digest_SPME.csv")
...
ggsave(filename = "E:\\github\\DDA-BERT\\psm_score_distribution\\Figure3_gradient_cell_PSMs_score.pdf", 
       plot = p_with_density,
       device = "pdf",
       width = 4,
       height = 4,
...
##Figure3H: PSMs barplot (single cell)
rm(list=ls())
df <- read_excel('E:\\github\\DDA-BERT\\DDA-BERT_figure_2024.xlsx', sheet = "single-cell2")
...
ggplot(data_summary, aes(x = FDR, y = mean_PSMs, fill = Tool)) +
  geom_bar(stat = "identity", position = position_dodge(), width = 0.6) +
  geom_errorbar(aes(ymin = mean_PSMs - sd_PSMs, ymax = mean_PSMs + sd_PSMs), 
...
ggsave(filename = "E:\\github\\DDA-BERT\\psm_barplot\\Figure3_1cell_PSMs.pdf", 
       plot = last_plot(),
       device = "pdf",
       width = 2.3,
       height = 2.3, 
...
##Figure3I: precursor barplot (single cell)
figure2B <- read_excel('E:\\github\\DDA-BERT\\DDA-BERT_figure_2024.xlsx', sheet = "precursor_num")
colnames(figure2B)[5] <- "Sample_type"
single_cell_data <- figure2B %>% filter(Sample_type == "1 cell (Hela cell)")
...
ggsave(filename = "E:\\github\\DDA-BERT\\precursor_barplot\\Figure3_1cell_precursor_barplot.pdf", 
       plot = last_plot(),
       device = "pdf",
       width = 2.3,
       height = 2.3, 
...
##Figure3J: peptide barplot (single cell)
figure2B <- read_excel('E:\\github\\DDA-BERT\\DDA-BERT_figure_2024.xlsx', sheet = "peptide_num")
colnames(figure2B)[5] <- "Sample_type"
single_cell_data <- figure2B %>% filter(Sample_type == "1 cell (Hela cell)")
...
ggsave(filename = "E:\\github\\DDA-BERT\\peptide_barplot\\Figure3_1cell_peptide_barplot.pdf", 
       plot = last_plot(),
       device = "pdf",
       width = 2.3,
       height = 2.3, 
...
##Figure3K--protein group barplot (single cell)
figure2B <- read_excel('E:\\github\\DDA-BERT\\DDA-BERT_figure_2024.xlsx', sheet = "pro_num")
colnames(figure2B)[5] <- "Sample_type"
single_cell_data <- figure2B %>% filter(Sample_type == "1 cell (Hela cell)")
...
ggsave(filename = "E:\\github\\DDA-BERT\\pro_barplot\\Figure3_1cell_pro_barplot.pdf", 
       plot = last_plot(),
       device = "pdf",
       width = 2.3,
       height = 2.3, 
...
data_dda_bert <- read_and_merge_with_info("E:\\DDA-BERT\\peptide_per_protein\\dda_bert", "Substrate_comp")
data_sage <- read_and_merge_with_info("E:\\DDA-BERT\\peptide_per_protein\\sage", "Substrate_comp")
data_fp <- read_and_merge_with_info("E:\\DDA-BERT\\peptide_per_protein\\fp", "Substrate_comp")
...
ggsave("E:\\github\\DDA-BERT\\pro_venn\\Figure3_single-cell_pro_venn.pdf", plot = p, device = "pdf", width = 1.7, height = 1.7)



##Figure3M: peptide_class_per_protein (single cell)
library(eulerr)
rm(list=ls())
process_file_data <- function(file_data, cleaned_sequence_col) {
  if (!cleaned_sequence_col %in% colnames(file_data)) {
...
ggsave(filename = "E:\\github\\DDA-BERT\\peptide_class_per_protein\\Figure3_1cell_peptide_class_per_protein.pdf", 
       plot = last_plot(),
       device = "pdf",
       width = 2.3,
       height = 2.3, 
...
##Figure3N: PSMs score distributions (single cell)
rm(list=ls())
data <- read.csv("E:\\DDA-BERT\\score_distribution\\Substrate_comp_Rapid_Method_Polypropylenechip.csv")
data$label <- ifelse(data$label == 1, "Target", "Decoy")
...
ggsave(filename = "E:\\github\\DDA-BERT\\psm_score_distribution\\Figure3_1cell_PSMs_score.pdf", 
       plot = p_with_density,
       device = "pdf",
       width = 4,
       height = 4,

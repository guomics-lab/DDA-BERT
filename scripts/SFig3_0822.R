...
rm(list=ls())
data <-  read.csv("D:\\paper\\guo-summer_25\\test_7_11\\test_8_18\\3\\DBSE_all_proteins_stats_0818.csv")
...
ggsave(filename = "D:\\paper\\guo-summer_25\\test_7_11\\test_8_18\\3\\SFigure_3_proteins_all_0818.pdf", 
       plot = last_plot(),
       device = "pdf",
       width = 8,
       height = 8, 

##SFigure7: yeast peptide upset
rm(list=ls())
library(ggplot2)
library(tidyr)
library(dplyr)
library(UpSetR)
df <- read.csv("D:\\paper\\guo-summer_25\\test_7_11\\test_8_18\\5-8\\data\\yeast_overlap_result0818.csv",row.names = 1)
...
pdf("D:\\paper\\guo-summer_25\\test_7_11\\test_8_18\\5-8\\png\\yeast_peptide_overlap_upset.pdf", width = 7, height = 7)

...
from ..services import fdr_psm_independent
...
class FdrCalcNoFinetuneProcessHandler(CommonProcessHandler):
    ...
    def deal_process(self):
        ...
        try:
            ...
            fdr_psm_independent.deal_process(self.f_info.base_file_name, sage_ipc, ap_ipc, fp_ipc, sage_pred, ap_pred, fp_pred,
                                      output_dir, self.open_sage, self.open_fp, self.open_ap, self.logger)

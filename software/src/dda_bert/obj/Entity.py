...
class InputParam(object):
    ...
    def __init__(self):
        ...
        self.sage_config_file = None
        self.fp_workflow_file = None
        self.ap_config_file = None
        ...
        self.mass_file_format = None
        self.search_engines = None
        self.only_run_predict = None

        self.mzml_ipc_file_dir = None
        self.sage_file_dir = None
        self.fp_file_dir = None
        self.ap_file_dir = None

...
ggplot(class_source_stats, aes(x = class, y = mean_count, fill = source)) +
  ...
  labs(x = "# precursors per protein group", y = "# proteins") +
  theme_minimal() +
  theme(
    legend.position = "top",
...
ggsave(filename = "E:\\DDA-BERT\\precursor_per_protein\\figures\\SFigure_cell-line_precursor_class.pdf", 
       plot = last_plot(),
       device = "pdf",
       width = 2.3,
       height = 2.3, 
...
ggsave(filename = "E:\\DDA-BERT\\precursor_per_protein\\figures\\SFigure_tissue_precursor_class.pdf", 
       plot = last_plot(),
       device = "pdf",
       width = 2.3,
       height = 2.3, 
...
ggsave(filename = "E:\\DDA-BERT\\precursor_per_protein\\figures\\SFigure_1cell_precursor_class.pdf", 
       plot = last_plot(),
       device = "pdf",
       width = 2.3,
       height = 2.3, 
...
ggsave(filename = "E:\\DDA-BERT\\precursor_per_protein\\figures\\SFigure_tims_precursor_class.pdf", 
       plot = last_plot(),
       device = "pdf",
       width = 2.3,
       height = 2.3, 
...
ggsave(filename = "E:\\DDA-BERT\\precursor_per_protein\\figures\\SFigure_Astral_precursor_class.pdf", 
       plot = last_plot(),
       device = "pdf",
       width = 2.3,
       height = 2.3, 
...
ggsave(filename = "E:\\DDA-BERT\\precursor_per_protein\\figures\\SFigure_mouse_precursor_class.pdf", 
       plot = last_plot(),
       device = "pdf",
       width = 2.3,
       height = 2.3, 
